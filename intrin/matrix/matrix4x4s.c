...
__m128 m4x4v_cs_SSE(const __m128 cols[static 4], const __m128 x) {
...
__m128 m4x4v_rs_SSE3(const __m128 rows[static 4], const __m128 x) {
...
__m128 m4x4v_rs_SSE4(const __m128 rows[static 4], const __m128 x) {
